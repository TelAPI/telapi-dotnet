...
namespace TelAPI
{
    public partial class TelAPIRestClient
    {
        ...
        /// </summary>
        /// <returns></returns>
        public UsageResult GetUsages()
        {
            return GetUsages(null, null, null, null, null, null);
        }
        ...
        /// <returns></returns>
        public UsageResult GetUsages(DateTime date)
        {
            return GetUsages(date.Day, date.Month, date.Year, null, null, null);
        }
        ...
        /// <returns></returns>
        public UsageResult GetUsages(Products product)
        {
            return GetUsages(null, null, null, null, null, product);
        }
        ...
        /// <returns></returns>
        public UsageResult GetUsages(int? page, int? pageSize)
        {
            return GetUsages(null, null, null, page, pageSize, null);
        }
        ...
        /// <param name="product">Returns a list of all usage for a specific "product" or feature of TelAPI.</param>
        /// <returns></returns>
        public UsageResult GetUsages(int? day, int? month, int? year, int? page, int? pageSize, Products? product)
        {
        ...
        /// <returns></returns>
        public Usage GetUsage(string sid)
        {
