...
// [TODO] : Fix roblem with deserialization of AvaliablePhoneNumberResult. 
...
namespace TelAPI
{
    public partial class TelAPIRestClient
    {
        ...
        /// <returns></returns>
        public AvaliablePhoneNumberResult GetAvaliablePhoneNumbers(string isoCountryCode)
        {
            return GetAvaliablePhoneNumbers(isoCountryCode, null, null, null, null);
        }
        ...
        /// <returns></returns>
        public AvaliablePhoneNumberResult GetAvaliablePhoneNumbers(string isoCountryCode, string areaCode)
        {
            return GetAvaliablePhoneNumbers(isoCountryCode, areaCode, null, null, null);
        }
        ...
        /// <returns></returns>
        public AvaliablePhoneNumberResult GetAvaliablePhoneNumbers(string isoCountryCode, string areaCode, string contains)
        {
            return GetAvaliablePhoneNumbers(isoCountryCode, areaCode, contains, null, null);
        }
        ...
        /// <returns></returns>
        public AvaliablePhoneNumberResult GetAvaliablePhoneNumbers(string isoCountryCode, string areaCode, string contains, string inRegion, string inPostalCode)
        {
            Require.Argument("IsoCountryCode", isoCountryCode);

            var request = new RestRequest();
            request.Resource = RequestUri.AvaliablePhoneNumbersUri;
            ...
            return Execute<AvaliablePhoneNumberResult>(request);
        }
    }
}
